...
#define LUX_DESERIALIZE_PROPERTY_ASSET(propName, destination, inputData, assetClass)\
		...
		{ LUX_CORE_ERROR_TAG("AssetManager", "Tried to load invalid asset {0}.", #assetClass); }}
