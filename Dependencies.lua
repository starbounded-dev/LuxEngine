...
Dependencies = {
	...
	NvidiaAftermath = {
		...
		IncludeDir = "%{wks.location}/StarEngine/vendor/NvidiaAftermath/include",
		Windows = { LibDir = "%{wks.location}/StarEngine/vendor/NvidiaAftermath/lib/x64/windows/" },
		Linux = { LibDir = "%{wks.location}/StarEngine/vendor/NvidiaAftermath/lib/x64/linux/" },
	},
	Assimp = {
		IncludeDir = "%{wks.location}/StarEngine/vendor/assimp/include",
		Windows = { LibName = "assimp-vc143-mt", DebugLibName = "assimp-vc143-mtd", LibDir = "%{wks.location}/StarEngine/vendor/assimp/bin/windows/%{cfg.buildcfg}/" },
		Linux = { LibName = "assimp", LibDir = "%{wks.location}/StarEngine/vendor/assimp/bin/linux/" },
		Configurations = "Debug,Release"
	},
	WinSock = {
		LibName = "Ws2_32"
	...
	ShaderC = {
		...
		IncludeDir = "%{wks.location}/StarEngine/vendor/shaderc/include",
		Configurations = "Debug,Release"
	},
	ShaderCUtil = {
		LibName = "shaderc_util",
		Windows = { DebugLibName = "shaderc_utild", },
		IncludeDir = "%{wks.location}/StarEngine/vendor/shaderc/libshaderc_util/include",
		Configurations = "Debug,Release"
	},
	SPIRVCrossCore = {
	...
	GLFW = {
		...
		LibName = "GLFW",
		IncludeDir = "%{wks.location}/StarEngine/vendor/GLFW/include",
	},
	GLAD = {
		LibName = "GLAD",
		IncludeDir = "%{wks.location}/StarEngine/vendor/GLAD/include",
	},
	Mono = {
	...
	EnTT = {
		IncludeDir = "%{wks.location}/StarEngine/vendor/entt/include",
	},
	ImGuizmo = {
		IncludeDir = "%{wks.location}/StarEngine/vendor/ImGuizmo",
	},
	STBImage = {
		IncludeDir = "%{wks.location}/StarEngine/vendor/stb_image",
	},
    Coral = {
		LibName = "Coral.Native",
        IncludeDir = "%{wks.location}/StarEngine/vendor/Coral/Coral.Native/Include"
    },
	ImGui = {
		LibName = "ImGui",
		IncludeDir = "%{wks.location}/StarEngine/vendor/imgui",
	},
	ImGuiNodeEditor = {
		IncludeDir = "%{wks.location}/StarEngine/vendor/imgui-node-editor",
	},
	NFDExtended = {
		LibName = "NFD-Extended",
		IncludeDir = "%{wks.location}/StarEngine/vendor/NFD-Extended/NFD-Extended/src/include"
	},
	NVRHI = {
		LibName = "NVRHI",
		IncludeDir = "%{wks.location}/StarEngine/vendor/NVRHI/include"
	},
	FastNoise = {
		IncludeDir = "%{wks.location}/StarEngine/vendor/FastNoise",
	},
	MiniAudio = {
		IncludeDir = "%{wks.location}/StarEngine/vendor/miniaudio/include",
	},
	Farbot = {
		IncludeDir = "%{wks.location}/StarEngine/vendor/farbot/include",
	},
	Choc = {
		IncludeDir = "%{wks.location}/StarEngine/vendor/choc",
	},
	MagicEnum = {
		IncludeDir = "%{wks.location}/StarEngine/vendor/magic_enum/include",
	},
	Box2D = {
		LibName = "Box2D",
		IncludeDir = "%{wks.location}/StarEngine/vendor/Box2D/include",
	},
	Tracy = {
		LibName = "Tracy",
		IncludeDir = "%{wks.location}/StarEngine/vendor/Tracy/tracy/public",
	},
	JoltPhysics = {
		LibName = "JoltPhysics",
		IncludeDir = "%{wks.location}/StarEngine/vendor/JoltPhysics/JoltPhysics",
	},
	MSDFAtlasGen = {
		LibName = "msdf-atlas-gen",
		IncludeDir = "%{wks.location}/StarEngine/vendor/msdf-atlas-gen/msdf-atlas-gen",
	},
	MSDFGen = {
		LibName = "msdfgen",
		IncludeDir = "%{wks.location}/StarEngine/vendor/msdf-atlas-gen/msdfgen",
	},
	Freetype = {
		LibName = "freetype"
	},
	STB = {
		IncludeDir = "%{wks.location}/StarEngine/vendor/stb/include",
	},
	YAML_CPP = {
		IncludeDir = "%{wks.location}/StarEngine/vendor/yaml-cpp/include",
	},
	WS2 = {
	...
	FileWatch = {
		IncludeDir = "%{wks.location}/StarEngine/vendor/filewatch"
	},
	CDT = {
		IncludeDir = "%{wks.location}/StarEngine/vendor/CDT"
	},
	RTM = {
		IncludeDir = "%{wks.location}/StarEngine/vendor/rtm/include"
	},
	ACL = {
		IncludeDir = "%{wks.location}/StarEngine/vendor/acl/include"
	},
	BackwardCPP = {
		IncludeDir = "%{wks.location}/StarEngine/vendor/backward-cpp"
	},
}
