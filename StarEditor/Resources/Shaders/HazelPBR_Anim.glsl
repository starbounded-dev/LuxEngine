...
layout(push_constant) uniform PushConstants
{
	...
	uint Base;
	uint Stride;
	uint Pad1; //padding to vec4 as thats needed
	uint Pad2;
...
void main()
{
	...
	mat4 boneTransform = r_BoneTransforms.BoneTransforms[u_BoneTransformIndex.Base + (gl_InstanceIndex * u_BoneTransformIndex.Stride) + a_BoneIndices[0]] * a_BoneWeights[0];
	boneTransform     += r_BoneTransforms.BoneTransforms[u_BoneTransformIndex.Base + (gl_InstanceIndex * u_BoneTransformIndex.Stride) + a_BoneIndices[1]] * a_BoneWeights[1];
	boneTransform     += r_BoneTransforms.BoneTransforms[u_BoneTransformIndex.Base + (gl_InstanceIndex * u_BoneTransformIndex.Stride) + a_BoneIndices[2]] * a_BoneWeights[2];
	boneTransform     += r_BoneTransforms.BoneTransforms[u_BoneTransformIndex.Base + (gl_InstanceIndex * u_BoneTransformIndex.Stride) + a_BoneIndices[3]] * a_BoneWeights[3];
