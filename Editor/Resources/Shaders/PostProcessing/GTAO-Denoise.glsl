...
void main()
{
    ...
    vec4 edgesQ2        = textureGatherOffset(sampler2D(u_Edges, r_LinearSampler), gatherCenter, ivec2(1, 2));

    AOTermType visQ0[4];    XeGTAO_DecodeGatherPartial(textureGatherOffset(usampler2D(u_AOTerm, r_LinearSampler), gatherCenter, ivec2(0, 0)), visQ0);
    AOTermType visQ1[4];    XeGTAO_DecodeGatherPartial(textureGatherOffset(usampler2D(u_AOTerm, r_LinearSampler), gatherCenter, ivec2(2, 0)), visQ1);
    AOTermType visQ2[4];    XeGTAO_DecodeGatherPartial(textureGatherOffset(usampler2D(u_AOTerm, r_LinearSampler), gatherCenter, ivec2(0, 2)), visQ2);
    AOTermType visQ3[4];    XeGTAO_DecodeGatherPartial(textureGatherOffset(usampler2D(u_AOTerm, r_LinearSampler), gatherCenter, ivec2(2, 2)), visQ3);
