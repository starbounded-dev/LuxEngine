...
def main():
    ...
    run([directory / "occlusion-test", directory], timeout=30)
    ...
    run(["clang++", *flags, TESTS / "PlatformTests.cpp", *audio_objects, *yaml, *libraries,
         *["-Wl,-rpath," + str(lib.parent) for lib in libraries], "-Wl,--gc-sections", "-pthread",
         "-o", directory / "platform-test"], cwd=ROOT / "Core")
    run([directory / "platform-test", banks, directory], timeout=60)
