#include "sepch.h"
#include "StarEngine/Utilities/ProcessHelper.h"
...
namespace StarEngine {
	...
	{
		SE_CORE_VERIFY(s_WindowsProcessStorage.find(inHandle) != s_WindowsProcessStorage.end(), "Trying to destroy untracked process!");
