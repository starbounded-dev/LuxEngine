...
#include "StarEngine/Physics/CharacterController.h"
#include "StarEngine/Physics/PhysicsContactCallback.h"
#include "StarEngine/Physics/PhysicsShapes.h"
...
namespace StarEngine {
	...
	public:
		...
		JPH::BodyID GetBodyID() const { return m_Controller->GetInnerBodyID(); }
