...
namespace StarEngine {
	...
	public:
		...
		Ref<PhysicsBody> GetBody(Entity entity) const { return GetBodyByEntityID(entity.GetUUID()); }
		...
		Ref<CharacterController> GetCharacterController(Entity entity) const { return GetCharacterControllerByEntityID(entity.GetUUID()); }
