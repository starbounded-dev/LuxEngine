...
namespace StarEngine {
	...
	public:
		...
		void OnRenderSimulation(Ref<SceneRenderer> renderer, const EditorCamera& editorCamera);

		void OnAssetReloaded(AssetHandle handle);
		void OnAnimationGraphReloaded(AssetHandle handle);
		void OnSkeletonReloaded(AssetHandle handle);
		void OnAnimationReloaded(AssetHandle handle);
		void OnMeshReloaded(AssetHandle handle);
		void OnMeshSourceReloaded(AssetHandle handle);
	...
	private:
		...
		void OnCharacterControllerComponentConstruct(entt::registry& registry, entt::entity entity);
		void OnCharacterControllerComponentDestroy(entt::registry& registry, entt::entity entity);
