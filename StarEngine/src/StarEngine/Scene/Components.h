...
namespace StarEngine {
	...
	{
		AssetHandle Mesh;
		Ref<StarEngine::MaterialTable> MaterialTable = Ref<StarEngine::MaterialTable>::Create();
		...
		SubmeshComponent(const SubmeshComponent& other)
			: Mesh(other.Mesh), MaterialTable(Ref<StarEngine::MaterialTable>::Create(other.MaterialTable)), BoneEntityIds(other.BoneEntityIds), SubmeshIndex(other.SubmeshIndex), Visible(other.Visible)
		{}
	...
	struct StaticMeshComponent
	{
		...
		StaticMeshComponent(const StaticMeshComponent& other)
			: StaticMesh(other.StaticMesh), MaterialTable(Ref<StarEngine::MaterialTable>::Create(other.MaterialTable)), Visible(other.Visible)
		{
		}
	...
	struct TileRendererComponent
	{
		...
		std::vector<Ref<StarEngine::MaterialTable>> Materials{ 1 }; // Width * Height material IDs
		std::vector<uint8_t> MaterialIDs{ 1 }; // Width * Height material IDs

		TileRendererComponent()
		{
			Materials[0] = Ref<StarEngine::MaterialTable>::Create();
		}
	};
