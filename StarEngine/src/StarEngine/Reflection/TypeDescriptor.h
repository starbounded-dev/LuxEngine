...
struct StarEngine::Type::Description<Class, Tag> : StarEngine::Type::MemberList<__VA_ARGS__>, StarEngine::Type::DescriptionInterface<StarEngine::Type::Description<Class,Tag>, Class, Tag, StarEngine::Type::MemberList<__VA_ARGS__>>	\
{																		\
private:																\
...
public:																	\
	...
	static constexpr std::array<std::string_view, NumberOfMembers> MemberNames										\
		= StarEngine::Utils::RemoveNamespace<NumberOfMembers>(																	\
			StarEngine::Utils::SplitString<NumberOfMembers>(MemberStr, Delimiter));												\
};
#endif // !DESCRIBED


#ifndef DESCRIBED
#define DESCRIBED(Class, ...) DESCRIBED_TAGGED(Class, StarEngine::Type::TDummyTag, __VA_ARGS__)
#endif
