...
namespace StarEngine {
	...
	void EditorConsolePanel::RenderMenu(const ImVec2& size)
	{
...

		{
			...
			if (UI::ColoredButton(SE_ICON_INFO_CIRCLE, GetToolbarButtonColor(m_MessageFilters & (int16_t)ConsoleMessageFlags::Info), textColor, buttonSize))
			...
			if (UI::ColoredButton(SE_ICON_EXCLAMATION_TRIANGLE, GetToolbarButtonColor(m_MessageFilters & (int16_t)ConsoleMessageFlags::Warning), textColor, buttonSize))
			...
			if (UI::ColoredButton(SE_ICON_EXCLAMATION_CIRCLE, GetToolbarButtonColor(m_MessageFilters & (int16_t)ConsoleMessageFlags::Error), textColor, buttonSize))
