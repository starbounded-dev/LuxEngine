...
#if SE_HAS_SPATIAL_AUDIO
		void DrawRotatedQuad(const glm::vec3& position, const glm::vec2& size, const glm::vec3& normal, const glm::vec4& color);
		void DrawQuad(const std::array<glm::vec3, 4>& verts, const glm::vec4& color);
#endif
