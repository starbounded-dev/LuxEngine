...
namespace StarEngine {
	...
	void Image2D::RT_Invalidate()
	{
		...
		{
			SE_CORE_VERIFY(!Utils::IsDepthFormat(m_Specification.Format));
			SE_CORE_VERIFY(m_Specification.Format != ImageFormat::SRGB);
			SE_CORE_VERIFY(m_Specification.Format != ImageFormat::SRGBA);
		}
