...
namespace StarEngine
{
	...
	public:
		...
		// Add the OnResize method
		virtual void OnResize(float width, float height)
		{
			// Default implementation: Update the projection matrix for an orthographic camera
			SetOrthoProjectionMatrix(width, height, 0.1f, 1000.0f);
		}
