...
namespace StarEngine {
	...
	public:
		...
		virtual ResourceDescriptorInfo GetDescriptorInfo() const override { SE_CORE_VERIFY(false); return nullptr; }
	...
	public:
		...
		virtual nvrhi::TextureHandle GetHandle() const override { return m_Handle; }
		virtual ImageFormat GetFormat() const override { return m_Specification.Format; }
		...
		virtual uint64_t GetHash() const override { return (uint64_t)m_Handle.Get(); }
	...
	private:
		...
		nvrhi::TextureHandle m_Handle = nullptr;
		nvrhi::SamplerHandle m_SamplerHandle = nullptr;
