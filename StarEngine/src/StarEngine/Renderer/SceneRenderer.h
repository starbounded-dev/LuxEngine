...
#include "StarEngine/Renderer/PipelineCompute.h"

#include "StorageBufferSet.h"

#include "StarEngine/Project/TieringSettings.h"
...
namespace StarEngine
{
	...
	public:
		SceneRenderer() = default; // Empty SceneRenderer
	...
	private:
		...
		glm::mat4* m_BoneTransformsData = nullptr;
		...
		{
			std::vector<glm::mat4> BoneTransformsData;
		...
		{
			nvrhi::TimerQueryHandle DirShadowMapPassQuery;
			nvrhi::TimerQueryHandle SpotShadowMapPassQuery;
			nvrhi::TimerQueryHandle DepthPrePassQuery;
			nvrhi::TimerQueryHandle HierarchicalDepthQuery;
			nvrhi::TimerQueryHandle PreIntegrationQuery;
			nvrhi::TimerQueryHandle LightCullingPassQuery;
			nvrhi::TimerQueryHandle GeometryPassQuery;
			nvrhi::TimerQueryHandle PreConvolutionQuery;
			nvrhi::TimerQueryHandle GTAOPassQuery;
			nvrhi::TimerQueryHandle GTAODenoisePassQuery;
			nvrhi::TimerQueryHandle AOCompositePassQuery;
			nvrhi::TimerQueryHandle SSRQuery;
			nvrhi::TimerQueryHandle SSRCompositeQuery;
			nvrhi::TimerQueryHandle BloomComputePassQuery;
			nvrhi::TimerQueryHandle JumpFloodPassQuery;
			nvrhi::TimerQueryHandle CompositePassQuery;
		} m_GPUTimeQueries;
