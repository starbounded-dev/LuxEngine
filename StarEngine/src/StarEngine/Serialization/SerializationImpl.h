...
#include "StarEngine/Serialization/StreamWriter.h"
#include "StarEngine/Serialization/StreamReader.h"

#include "StarEngine/Reflection/TypeDescriptor.h"
#include "StarEngine/Core/Identifier.h"
...
/**  Non-intrusive Binary / Memory Serialization Interface.
	...
	namespace StarEngine::Spatialization::Impl
	{
		template<>
...
struct StarEngine::Type::Description<Class> : StarEngine::Type::MemberList<__VA_ARGS__> {};\

namespace StarEngine::Serialization
{
	//=============================================================================
	/// Serialization
	...
	namespace Impl
	{
		...
		*/
		...
		template<>
		SE_EXPLICIT_STATIC inline bool SerializeImpl(StreamWriter* writer, const UUID& v)
		{
		...
		template<>
		SE_EXPLICIT_STATIC inline bool SerializeImpl(StreamWriter* writer, const Identifier& v)
		{
		...
		template<>
		SE_EXPLICIT_STATIC inline bool SerializeImpl(StreamWriter* writer, const std::string& v)
		{
		...
		//=============================================================================
		template<typename T>
		SE_EXPLICIT_STATIC bool SerializeVec(StreamWriter* writer, const std::vector<T>& vec)
		{
			//if (writeSize)
		...
		//=============================================================================
		template<typename T>
		SE_EXPLICIT_STATIC bool SerializeByType(StreamWriter* writer, const T& v)
		{
	...
	namespace Impl
	{
		...
		*/
		...
		template<>
		SE_EXPLICIT_STATIC inline bool DeserializeImpl(StreamReader* reader, UUID& v)
		{
		...
		template<>
		SE_EXPLICIT_STATIC inline bool DeserializeImpl(StreamReader* reader, Identifier& v)
		{
			uint32_t data;
			reader->ReadRaw(data);
			v = data;
		...
		template<>
		SE_EXPLICIT_STATIC inline bool DeserializeImpl(StreamReader* reader, std::string& v)
		{
			reader->ReadString(v);
			return true;
		}
		...
		//=============================================================================
		template<typename T>
		SE_EXPLICIT_STATIC bool DeserializeVec(StreamReader* reader, std::vector<T>&vec)
		{
			uint32_t size = 0;
			//if (size == 0)
		...
		//=============================================================================
		template<typename T>
		SE_EXPLICIT_STATIC bool DeserializeByType(StreamReader* reader, T& v)
		{
			if constexpr (Type::Described<T>::value)
			{
				return Type::Description<T>::Apply(
